...
##### Project settings
ahk launch
ak_.lnk C:\user\job\data\setting\macro\scriptApp\SD_AHK_code_exe.ahk "Run 'C:\Users\j.boldewijn\AppData\Local\Programs\Microsoft VS Code\Code.exe' 'c:\user\job\data\setting\keyboard\CornePi\'"
...
Key suitable for tab dance
One shot keys usage
	No repeat
new function on hold
Esc 

New function on single shot
Ctrl 
Alt

	Repeat useable if repeat is not used so only on time press test if desireable 
Space
Enter
Backspace
Del
