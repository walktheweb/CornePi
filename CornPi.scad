...
/*
11T=[00.0, -00.0, 00]; 12T=[24.8, -00.0, 00]; 13T=[49.1, -00.0, 00]; 14T=[73.5, -00.0, 00]; 15T=[ 93.5, -00.0, 00];
21T=[04.9, -20.0, 00]; 22T=[35.5, -20.0, 00]; 23T=[59.0, -20.0, 00]; 24T=[83.7, -20.0, 00]; 25T=[102.7, -20.0, 00];
31T=[14.1, -40.0, 00]; 32T=[40.6, -40.0, 00]; 33T=[59.9, -40.0, 00]; 34T=[78.5, -40.0, 00]; 35T=[ 97.5, -40.0, 00];
41T=[24.1, -60.0, 00]; 42T=[45.6, -60.0, 00]; 43T=[63.6, -60.0, 00]; 44T=[84.1, -60.0, 00]; 45T=[104.4, -60.0, 00];

11R=[00.0, 00.0, 00]; 12R=[00.0, 00.0, 00]; 13R=[00.0, 00.0, 00]; 14R=[00.0, 00.0, 00]; 15R=[00.0, 00.0, 00];
21R=[00.0, 00.0, 00]; 22R=[00.0, 00.0, 00]; 23R=[00.0, 00.0, 00]; 24R=[00.0, 00.0, 00]; 25R=[00.0, 00.0, 00];
31R=[00.0, 00.0, 00]; 32R=[00.0, 00.0, 00]; 33R=[00.0, 00.0, 00]; 34R=[00.0, 00.0, 00]; 35R=[00.0, 00.0, 00];
41R=[00.0, 00.0, 00]; 42R=[00.0, 00.0, 00]; 43R=[00.0, 00.0, 00]; 44R=[00.0, 00.0, 00]; 45R=[00.0, 00.0, 00];
...
module moveTile(vecTrans, vecRotate)
{
      translate(vecTrans){rotate(vecRotate){tile();}}
}
*/

//tempPrintTile();
//vertical travel no gaps check col row cluster space contine y offset
11T=[00.0, -00.0, 00]; 11R=[00.0, 00.0, 00]; 12T=[24.8, -00.0, 00]; 12R=[00.0, 00.0, 00]; 13T=[49.1, -00.0, 00]; 13R=[00.0, 00.0, 00]; 14T=[73.5, -00.0, 00]; 14R=[00.0, 00.0, 00]; 15T=[ 93.5, -00.0, 00]; 15R=[00.0, 00.0, 00];
21T=[04.9, -20.0, 00]; 21R=[00.0, 00.0, 00]; 22T=[35.5, -20.0, 00]; 22R=[00.0, 00.0, 00]; 23T=[59.0, -20.0, 00]; 23R=[00.0, 00.0, 00]; 24T=[83.7, -20.0, 00]; 24R=[00.0, 00.0, 00]; 25T=[102.7, -20.0, 00]; 25R=[00.0, 00.0, 00];
31T=[14.1, -40.0, 00]; 31R=[00.0, 00.0, 00]; 32T=[40.6, -40.0, 00]; 32R=[00.0, 00.0, 00]; 33T=[59.9, -40.0, 00]; 33R=[00.0, 00.0, 00]; 34T=[78.5, -40.0, 00]; 34R=[00.0, 00.0, 00]; 35T=[ 97.5, -40.0, 00]; 35R=[00.0, 00.0, 00];
                                                                                          43T=[63.6, -60.0, 00]; 43R=[00.0, 00.0, 00]; 44T=[84.1, -60.0, 00]; 44R=[00.0, 00.0, 00]; 45T=[104.4, -60.0, 00]; 45R=[00.0, 00.0, 00];
...
module main_easyDactyl()
{
    ...
    translate([-41, -34, 0]){rotate([0, 0, -3]){thumbCluster();}}
    col_five();
}
