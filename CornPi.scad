...
/*
https://www.blocklayer.com/graph-papereng
Put key caps with gum for layout
puncture center of of caps 
measure Y and X in 
...
[{y:-0.87,x:5},"V"],
[{y:-0.75,x:6.25},"B"],
[{y:-0.87,x:1.25},"Z",{x:10.5,a:7},"LT"],
[{y:-0.88,x:8.75,a:4},"N"],
[{y:-0.87,x:14},"?\n/"],
[{y:-0.38,x:3.75,a:7},"Ctrl"],
[{y:-0.99,x:10},"Space"],
[{y:-0.88,x:5.25},"Alt",{x:0.5},"Win"],
[{y:-0.87,x:11.5},"LT"],
[{y:-0.88,x:8.75},"Enter"],
[{ry:0.75,y:2,x:12.75,a:4},"LL"]
